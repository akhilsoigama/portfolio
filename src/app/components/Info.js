...
export default function ContactInfo() {
  return (
    <div className="max-w-md mx-auto p-6  space-y-4">
      <div className="flex items-center justify-start  border p-4 rounded-lg bg-gradient-to-tr from-white to-slate-400/60 dark:from-gray-800/10 dark:to-gray-700/10 dark:backdrop-blur-md shadow-md hover:shadow-lg transition-shadow duration-300 space-x-4">
